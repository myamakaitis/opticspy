...
RL2 = roc.ThinLens(fRL2, diameter=25, loc=locRL2)
...
ps5 = roc.PointSource(WD, 3, .05, color='autumn', num=51)
cs00 = roc.CollimatedSource(6, theta=.00, num=71, zstart=-150, color = 'PiYG')
col_t = .02
cs05 = roc.CollimatedSource(6 - (150+WD)*col_t, r_min= -6-(150+WD)*col_t, theta=col_t, num=71, zstart=-150, color = 'coolwarm')
